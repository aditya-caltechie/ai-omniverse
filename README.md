...
Refer: **[`LLM_CORE_TRACK.md`](LLM_CORE_TRACK.md)** (week-by-week map) · **[`LLM-TRAINING.md`](LLM-TRAINING.md)** (pre-train / FT / PEFT stages) · **[`FINE-TUNING.md`](FINE-TUNING.md)** (SFT, LoRA, QLoRA, prompt tuning)
