...
| **Topic** | **Repo** | **Description** |
| --------- | -------- | --------------- |
| Healthcare-Pro SAAS app on Vercel | [ai-healthcare-pro](https://github.com/aditya-caltechie/ai-healthcare-pro)| Deploying AI based healthcare SAAS app on **Vercel**, with clerk auth. Learn a bit of frontend. Can be deployed to both vercel and AWS |
